...
/* ═══════════════════════════════════════════
   About Page
   ═══════════════════════════════════════════ */
export default function AboutClient({ club: initialClub }: { club: Club | null }) {
  const [club, setClub] = useState<Club | null>(initialClub);

  /* The server fetched the club already, so its real details are in the initial
     HTML. Only fall back to a browser fetch if the server got nothing back. */
  const needsClientFetch = !initialClub;
