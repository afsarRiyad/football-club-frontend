...
export default function MatchDetailClient({
  ...
  /* The server already rendered the match, so teams, score and events are in the
     initial HTML. Only fall back to a browser fetch if the server got nothing. */
        ...
        <div className="px-6 py-8 md:py-12">
          <div className="flex items-center justify-center gap-4 md:gap-8">
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:justify-end gap-3 md:gap-4">
              {homeLogo ? (
                <Image src={homeLogo} alt={homeName} width={80} height={80} className="w-16 h-16 md:w-20 md:h-20 rounded-full object-contain border border-line/30" sizes="80px" />
              ) : (
            ...
            <div className="flex-1 flex flex-col items-center md:flex-row md:justify-start gap-3 md:gap-4">
              ...
              {awayLogo ? (
                <Image src={awayLogo} alt={awayName} width={80} height={80} className="w-16 h-16 md:w-20 md:h-20 rounded-full object-contain border border-line/30" sizes="80px" />
              ) : (
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-surface-raised border border-line/30 flex items-center justify-center">
